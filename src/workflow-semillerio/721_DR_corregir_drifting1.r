...
PARAM <- list()
PARAM$experimento <- "DR7211"

PARAM$exp_input <- "CA7111"

PARAM$variables_intrames <- TRUE # atencion esto esta en TRUE

# valores posibles
#  "ninguno", "rank_simple", "rank_cero_fijo", "deflacion", "normalizar"
PARAM$metodo <- "normalizar"
...
switch(PARAM$metodo,
  ...
  "normalizar"     = drift_normaliza(campos_monetarios)
)
